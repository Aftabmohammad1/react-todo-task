          ...
          <ul className="navbar-nav ms-auto">
            ...
            <li className="nav-item dropdown">
              ...
              <div
                ...
                aria-labelledby="liveClassesDropdown"
              >
                <div className="container">
                  <div className="row">
                    <div className="col-md-12">
                      ...
                      <a
                        ...
                        href="https://www.guvi.in/zen-class/full-stack-development-course/"
                      >
                        <p>Full Stack Development Program (FSD)</p>
                        <span className="small text-gray">
                          Learn Javascript, HTML, CSS, Java, MongoDB & more
                        </span>
                      </a>
                      <a
                        className="dropdown-item"
                      ...
                      <a
                        className="dropdown-item"
                        href="https://www.guvi.in/zen-class/automation-testing-course/"
                      >
                    ...
                    <div className="col-md-12">
                      <a
                        className="dropdown-item"
                        href="https://www.guvi.in/zen-class/"
                      >
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="practiceDropdown">
                <a
                  className="dropdown-item"
                  href="https://www.guvi.in/code-kata"
                >
                  <p>Codekata</p>
                  <span className="small text-gray">
            ...
            <li className="nav-item dropdown">
              ...
              >
                ...
                <a
                  className="dropdown-item"
                  href="https://www.guvi.in/referral"
                >
                  REFERRAL
                </a>
            ...
            <li className="nav-item dropdown">
              ...
              <div className="dropdown-menu" aria-labelledby="productsDropdown">
                ...
                <a
                  className="dropdown-item"
                  href="https://www.guvi.in/mlp/GUVI-for-corporates"
                >
