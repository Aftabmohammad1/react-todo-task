  ...
  const blogCardData = [
    {
      ...
      description:
        "Ever seen those moving pictures on your screen that tell a story? That's motion graphics!",
      date: "28 August 2023",
    },
    {
      id: 2,
      ...
      description:
        "In today's digital age, staying ahead of the curve in the field of marketing is",
      date: "28 August 2023",
    },
    {
      id: 3,
            ...
            <div className="col-12 col-md-4 col-sm-6" key={blog.id}>
              <div className="card">
                ...
                <div className="card-body">
                  <p className="title">
                    <Link className="card-title">{blog.title}</Link>
                  </p>
